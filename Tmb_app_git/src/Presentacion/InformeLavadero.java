 ...
 */
public class InformeLavadero extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Seleccionar el codigo del Lavador y especificar la fecha del reporte a crear.");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(jPanel_Informe, javax.swing.GroupLayout.PREFERRED_SIZE, 182, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(22, 22, 22)
                                .addComponent(jPanel_Cancelar, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addComponent(jCombo_TpoLvador, javax.swing.GroupLayout.Alignment.TRAILING, 0, 343, Short.MAX_VALUE)
    ...
    private void jPanel_InformeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel_InformeMouseClicked
        ...
        if(!fechaInforme.getEditor().getText().equalsIgnoreCase("") && 
                jCombo_TpoLvador.getSelectedIndex()!=-1 && jCombo_TpoLvador.getItemCount()!=0)
        {
            ResultaInfLavadero f = new 
            ResultaInfLavadero(Integer.valueOf((String)jCombo_TpoLvador.getSelectedItem()),fechaInforme.getEditor().getText());
            this.removeAll();
