 ...
 */
public class ResultaInfLavaderoDiario extends javax.swing.JPanel {
    ...
    public ResultaInfLavaderoDiario(String fecha) {
        initComponents();
        this.fecha = fecha;
    ...
    public JTable BuildTable(ArrayList<Informe_Lavadero> inforecep) {
        JTable tabla = new JTable();
        DefaultTableModel modelo = new DefaultTableModel(){
            public boolean isCellEditable(int rowIndex,int columnIndex){return false;}};
        float total=0;
        modelo.addColumn("LAVADOR");
        modelo.addColumn("VALOR TOTAL");
        Object[] fila = new Object[2];
        for (int i = 0; i < inforecep.size(); i++) {
            fila[0] = inforecep.get(i).getLavador_names();
            fila[1] = (long)inforecep.get(i).getValor_total();
            total = total + inforecep.get(i).getValor_total();
            modelo.addRow(fila);
        }
        fila[0] = "Total";
        fila[1] = (long) total;
